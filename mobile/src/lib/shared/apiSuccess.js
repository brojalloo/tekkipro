...
const LOCAL_SUCCESS_MESSAGES = Object.freeze({
  fr: Object.freeze({
    auth: Object.freeze({ login: 'Connexion réussie.' }),
    boutique: Object.freeze({ create: 'Boutique créée avec succès.', delete: 'Boutique supprimée avec succès.' }),
    client: Object.freeze({ create: 'Client ajouté avec succès.', update: 'Client mis à jour avec succès.', delete: 'Client supprimé avec succès.' }),
    employe: Object.freeze({ create: 'Employé ajouté avec succès.' }),
    fournisseur: Object.freeze({ create: 'Fournisseur ajouté avec succès.', update: 'Fournisseur mis à jour avec succès.', delete: 'Fournisseur supprimé avec succès.' }),
    ...
    settings: Object.freeze({ update: 'Paramètres mis à jour avec succès.' }),
    stock: Object.freeze({ update: 'Stock mis à jour avec succès.' }),
    dette: Object.freeze({ repay: 'Paiement enregistré avec succès.' }),
  ...
  en: Object.freeze({
    auth: Object.freeze({ login: 'Signed in successfully.' }),
    boutique: Object.freeze({ create: 'Store created successfully.', delete: 'Store deleted successfully.' }),
    client: Object.freeze({ create: 'Client added successfully.', update: 'Client updated successfully.', delete: 'Client deleted successfully.' }),
    employe: Object.freeze({ create: 'Employee added successfully.' }),
    fournisseur: Object.freeze({ create: 'Supplier added successfully.', update: 'Supplier updated successfully.', delete: 'Supplier deleted successfully.' }),
    produit: Object.freeze({
    ...
    settings: Object.freeze({ update: 'Settings updated successfully.' }),
    stock: Object.freeze({ update: 'Stock updated successfully.' }),
    dette: Object.freeze({ repay: 'Payment recorded successfully.' }),
    subscription: Object.freeze({
